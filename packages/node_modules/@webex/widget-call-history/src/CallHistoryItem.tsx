    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Text type="body-secondary" className={sc('date')}  aria-label={startTime && formatDate(startTime)}>
              {startTime && formatDate(startTime)}
            </Text>
            <Text type="body-secondary" className={`${sc('time')} ${sc('margin_adjust')}`} aria-label={startTime && formatTime(startTime)}>
