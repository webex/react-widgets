      ...
      <ListItemBaseSection position="fill" className={sc('content')}>
        <Flex>
          ...
          {!(callingSpecific && name) &&
            <div title={phoneNumber} className={`${ (name || callingSpecific) && phoneNumber ? sc('name_number') : ''}`}>
            <Text 
              type="body-secondary" 
           ...
           {(callingSpecific && (name || phoneNumber)) &&
            <div className={`${ name && phoneNumber ? sc('name_number') : (phoneNumber && callingSpecific) ? sc('name_number') : ''}`}>
              <Text
              type="body-secondary" 
