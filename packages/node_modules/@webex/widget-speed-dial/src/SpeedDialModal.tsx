...
export const SpeedDialModal = ({
  ...
  return (
    <div aria-modal="true" role="dialog" aria-label={t('webex.calling') + "," + headerText + "," + t('voiceover.addSpeedDial.windowDialog')}>
    <GenericModal isOpen={isOpen} className={cssClasses}>
      <Flex className={sc('header')} direction="column">
        <Flex className={sc('header-text')}>
          <Text className='header-text' type="header-secondary" aria-hidden="true">{t('webex.calling')}</Text>
          <ButtonCircle className='cancel-button' ghost onPress={onCancel} aria-hidden="true" aria-label={t("voiceover.addSpeedDial.closeBtn")} onKeyDown={handleEnterKeyPress}>
        ...
        <Flex className={sc('subheader-text')}>
          <Text className='subheader-text' type="header-primary" aria-hidden="true">{headerText}</Text>
