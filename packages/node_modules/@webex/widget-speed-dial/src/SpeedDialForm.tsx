...
export const SpeedDialForm = ({
  ...
  const validation = (!formState.isValid || !formState.isDirty);
          ...
          <Controller
            ...
            render={({ field: { name, onChange } }) => (
              <Select
                ...
                disabledKeys={[formData?.phoneType as React.Key]}
                defaultSelectedKey={
      ...
      {isEdit && (
        <>
          ...
          <div className={sc('input-container', ['row', 'required'])}>
            ...
            <Controller
              ...
              render={({ field: { name, onChange } }) => (
                <Select
                  ...
                  onSelectionChange={(key) => {
                    setFormData({ ...formData, phoneType: key.toString(), currentCallAddress: key === PhoneType.EMAIL ? formData.mail : key !== PhoneType.EMAIL ? formData.phone : ''});
                    onChange(key.toString());
                    setFocus('phone');
                  }}
                >
            ...
            />
            {/* Phone - Number */}
            {formData.phoneType !== PhoneType.EMAIL && formData.phoneType !== PhoneType.SIP && (
              <Controller
                control={control}
                name="phone"
                rules={{
            ...
            {/* Phone - Email */}
            {formData.phoneType === PhoneType.EMAIL && (
              <Controller
                control={control}
                name="mail"
                rules={{
      ...
      {!isEdit && !isContact && (
        <>
          ...
          <div className={sc('input-container', ['row', 'required'])}>
            ...
            />
            {/* Phone - Number */}
            {formData.phoneType !== 'Email' && formData.phoneType !== 'SIP' && (
              <Controller
                control={control}
                name="phone"
                rules={{
