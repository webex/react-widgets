...
export const SpeedDialForm = ({
  ...
  return (
    <form
      ...
      aria-label={focusCount == 1 ? t('webex.calling') + "," + headerText + ","  + t('voiceover.addSpeedDial.windowDialog') : ""}
    >
      {/* Phone Select Input */}
      {isContact && (
      ...
      <Flex className={sc('footer')} justifyContent="flex-end" xgap="1rem">
        ...
        <ButtonPill type="submit" size={32} disabled={validation} onFocus={handleFocus} className="btn-margin-left" onKeyDown={handleEnterKeyPress}>
          {addText}
        </ButtonPill>
      </Flex>
    </form>
