...
export const SpeedDialForm = ({
  ...
  const processSubmit = (speedDialData: IFormData) => {
    //commted out add name,phoneNumbers other newly added type in IformDate(in component adapter interface then un comment below lines)
    ...
    //after un comment above delete the below one
    const currentCallAddress = undefined;
