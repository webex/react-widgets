...
export const SpeedDialForm = ({
  ...
  return (
    console.log('callType: ' + formData.callType),
    console.log('phoneType: ' + formData.phoneType),
    <form
      id="speedDialForm"
    ...
    >
                  ...
                  >
                    {usedPhonesList.includes(item.key)
                      ...
                      <div title={item.value} className="disablePhoneList">
                        ...
                        <p className='inUseText' aria-label={inUseText}>{inUseText}</p>
                      </div>
            ...
            <Controller
              ...
              render={({
                ...
                <TextInput
                  ...
                  aria-label={t('form.firstName.placeholder')}
            ...
            <Controller
              ...
              render={({ field: { name, ref, onChange, onBlur, value } }) => (
                <TextInput
                  ...
                  aria-label={t('form.lastName.placeholder')}
              ...
              <Controller
                ...
                render={({
                  ...
                  <TextInput
                    ...
                    aria-label={t('form.phone.placeholder')}
                    onBlur={onBlur}
                    onInput={(e) => {
                      setFormData({
                        ...formData,
              ...
              <Controller
                ...
                render={({
                  ...
                  <TextInput
                    ...
                    aria-label={t('form.mail.placeholder')}
                    onBlur={onBlur}
                    onInput={onChange}
                    ref={ref}
                    messageArr={
              ...
              <Controller
                ...
                render={({
                  ...
                  <TextInput
                    ...
                    aria-label={t('form.sip.placeholder')}
                    onBlur={onBlur}
                    onInput={onChange}
                    ref={ref}
                    messageArr={
        ...
        <Controller
          ...
          render={({ field: { name, onChange } }) => (
            <Select
              ...
              aria-label={isContact ? t('voiceover.addSpeedDial.callTypeSelected', { callType: t('voiceover.addSpeedDial.audioCall') }) : (formData.callType === PhoneType.HANDSET ? t('voiceover.addSpeedDial.callTypeSelected', { callType: t('voiceover.addSpeedDial.audioCall') }) : t('voiceover.addSpeedDial.callTypeSelected', { callType: t('voiceover.addSpeedDial.videoCall')}))}
              isDisabled={formData.phoneType ? false : true }
      ...
      <Flex className={sc('footer')} justifyContent="flex-end" xgap="1rem">
        ...
        <ButtonPill type="submit" size={32} disabled={validation} className="btn-margin-left" onKeyDown={handleEnterKeyPress}>
          {addText}
        </ButtonPill>
      </Flex>
    </form>
