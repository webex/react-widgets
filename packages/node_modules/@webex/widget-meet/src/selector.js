...
const getMeeting = createSelector(
  ...
  (widget, sdkAdapter) => {
    const meeting = widget.callId ? sdkAdapter?.meetingsAdapter.datasource.meetings.getMeetingByType('id', widget.callId) : null;

    // eslint-disable-next-line no-console
    console.log('HELLO [getMeeting] widget.callId:', widget.callId, 'meeting:', meeting);
