...
describe('Adaptive Card Util functions', () => {
  ...
  it('returns a proccesed adaptive card with styles when the card json has different elements', () => {
    expect(getAdaptiveCard(adaptiveCardActivity.object.cards, sdkInstance)).toMatchSnapshot();
  });
});
