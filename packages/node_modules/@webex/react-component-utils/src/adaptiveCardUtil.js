import * as AdaptiveCard from '@webex/react-component-utils/src/node_modules/adaptivecards';
import MDTextInput from '@webex/react-component-utils/src/node_modules/@webex/react-component-md-text-input';
import MDToggleInput from '@webext-component-utils/src/node_modules/@webex/react-component-md-toggle-input';
import MDChoiceSetInput from '@webext-component-utils/src/node_modules/@webex/react-component-md-choiceset-input';
import {createMessageObject} from '@webext-component-utils/src/node_modules/@webex/redux-module-activity';

import {CARD_ATTACHMENT_TYPE, TEXT_INPUT_ELEMENT, TOGGLE_INPUT_ELEMENT, CHOICE_SET_INPUT_ELEMENT, ADAPTIVE_CARD_HOST_CONFIG} from '@webex/react-component-utils/src/constants';
 ...
 * @returns {object}
 */
export function getAdaptiveCard(cards, displayName, sdkInstance, addChildNode = null) {
