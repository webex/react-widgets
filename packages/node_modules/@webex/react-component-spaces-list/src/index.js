...
import {getBadgeState, getGlobalNotificationState, hasMentions} from '@ciscospark/react-component-utils';
  ...
  return (
    <div style={{height: '100%', width: '100%'}}>
      <AutoSizer>
        {({height, width}) => (
          <List
            className={classNames('ciscospark-spaces-list', styles.spacesListDark)}
            height={height}
            onScroll={onScroll}
            rowCount={rowCount}
            rowHeight={52}
