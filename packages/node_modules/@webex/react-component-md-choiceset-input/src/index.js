...
import {renderCardElement, DEFAULT_VALUE_SELECT_BOX, DEFAULT_VALUE_CHECK_BOX} from '@webex/react-component-utils';
...
class MDChoiceSetInput extends AdaptiveCard.ChoiceSetInput {
  ...
  internalRender() {
    ...
    if (!this.isMultiSelect) {
      ...
      if (this.isCompact) {
        // Render Select box
        let defaultOptionText = DEFAULT_VALUE_SELECT_BOX;
