...
export const VoicemailPlaybackControls = ({
  ...
  return (
    ...
    >
      {playing && audioSrc ? (
        <ButtonCircle outline size={28} onPress={() => setPlaying(false)} data-testid="pause-button">
          <IconNext name="pause" autoScale={150} />
        </ButtonCircle>
      ) : (
        (audioSrcLoader && audioSrc === '') ?  (<div className="md-loading-spinner-wrapper" data-testid="loading-icon">
        ...
        <div className="md-icon-wrapper md-loading-spinner-arch">
          ...
          :
          (<ButtonCircle outline size={28} onPress={playAudio} data-testid="play-button">
