...
export const VoicemailItem = ({
  ...
  const formattedTime = `Time ${isLocaleGerman ? formatTimeToSupport24Hours(voicemail.date) : formatTime(voicemail.date)}`;
    ...
    >
      <ListItemBaseSection position="fill">
        ...
        <VoicemailPlaybackControls
          ...
          isAnnouncePlayOrPause={isAnnouncePlayOrPause} 
