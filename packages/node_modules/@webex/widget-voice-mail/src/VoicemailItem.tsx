...
export const VoicemailItem = ({
  ...
  const palyOrPause = isAnnouncePlayOrPause ? t('pauseVoicemail') : t('playVoicemail');
  ...
  return (
    <ListItemBase
      ...
      itemIndex={itemIndex}
      aria-label={`${unread ? t('unreadVoicemail') + ',' : ''} ${(voicemail.name)}, ${formatPhoneNumberForAnnouncement(voicemail.address)}, ${palyOrPause}, ${(formatVoiceMailTimeDurationForAnnouncement(voicemail.duration as number))}, ${t('voicemailPlayButton')}, ${t('voicemailScrubbingBar')}, ${formattedDate}, ${formattedTime}, ${t('audioCallLabel')}, ${t('videoCallLabel')}, ${t('deleteVoicemail')}, ${t('voicemailFocusButton')}`}
    >
