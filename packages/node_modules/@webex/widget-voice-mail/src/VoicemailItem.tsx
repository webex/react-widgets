  ...
  return (
    ...
    >
      <ListItemBaseSection position="fill">
        <Avatar initials={removeBracketsAndContent(voicemail.name)} title={voicemail.name} size={32} className={sc('avatar')} />
        ...
        <div className={sc('meta')}>
          ...
          <Flex xgap=".5rem" className={sc('actions')}>
            ...
            {onDelete && (
              <ButtonCircle size={28} outline onPress={onDelete}  data-testid="delete-button">
