...
class DemoWidget extends Component {
  ...
  async handleOpenRecentsWidget(e) {
    ...
    if (this.state.accessTokenType === 'JWT') {
      ...
      widgetOptions.sdkInstance = await createSDKInstance(this.state.accessToken);
    }
    else {
  ...
  @autobind
  handleAccessTokenChange(accessToken, accessTokenType, generateSDKInstance) {
    return this.setState({accessToken, accessTokenType, generateSDKInstance});
  }
        ...
        <div>
          <div className={styles.section}>
            <div>
              ...
              <p>Our widgets are built using <a href="https://github.com/facebook/react">React</a>, <a href="https://github.com/reactjs/redux">Redux</a>, and the <a href="https://github.com/webex/webex-js-sdk">Webex Teams Javascript SDK </a>.</p>
            </div>
          </div>
