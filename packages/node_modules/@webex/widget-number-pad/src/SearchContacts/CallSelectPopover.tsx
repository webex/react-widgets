...
>(({ callables, isVideo, children , makeCall, label}, ref) => {
  ...
  if (callables.length === 1) {
    return React.cloneElement(children, {
      onPress: () => makeCall && makeCall(callables[0].address, isVideo, label == 'Search channel members' ? channelLabel : searchPadLabel),
    });
  }
      ...
      <ListNext listSize={callables.length}>
        {callables.map((item, callableIndex) => (
          <ListItemBase
            ...
            isPadded
            onPress={() => makeCall && makeCall(item.address, isVideo, label == 'Search channel members' ? channelLabel : searchPadLabel)}
          >
