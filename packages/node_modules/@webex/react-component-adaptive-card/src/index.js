...
class AdaptiveCard extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps !== this.props) {
      ...
      if (this.props.conversation.get('lastAcknowledgedCardActionActivity')) {
        ...
        (!!this.lastAcknowledgedCardActionActivityId) && this.state.isCardActionCicked) {
          setTimeout(() => {
  ...
  handleSubmitAction(url, actionInput, parentId) {
    ...
    this.setState({isCardActionCicked: true});
  }
  ...
  */
  dismissStatusMessage() {
    setTimeout(() => {
      ...
      this.setState({isCardActionCicked: false});
      this.lastAcknowledgedCardActionActivityId = null;
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        {
        this.state.isCardActionCicked && (this.state.isCardActionSubmissionFailed
        ? (
