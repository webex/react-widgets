  ...
  return (dispatch, getState) => {
    ...
    return sparkInstance.internal.user.get()
      .then((user) => {
        ...
        if (user.photos && user.photos[0].photoUrl) {
