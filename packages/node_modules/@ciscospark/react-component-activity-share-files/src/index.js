...
import {cardReference} from '@ciscospark/react-component-utils';
...
export function ActivityShareFiles(props) {
  ...
  const items = files.map((file) => {
    ...
    if (file.image && file.type !== cardReference) {
      if (isPending) {
  ...
  return (
    <ActivityItemBase {...props}>
      <div className={classNames('ciscospark-activity-share-list', styles.shareList)}>
        {renderAdaptiveCard && <AdaptiveCard cards={cards} displayName={displayName} />}
        {items}
        {textItem}
      </div>
    </ActivityItemBase>
