...
import {injectSparkMetrics, reducer as metricsReducer} from '@ciscospark/react-redux-spark-metrics';
...
export default function constructSparkWidget(widgetName, Widget, options = {}) {
  ...
  if (widgetOptions.get(`metrics`)) {
    WidgetComponent = injectSparkMetrics(WidgetComponent);
    widgetOptions = widgetOptions.setIn([`reducers`, `metrics`], metricsReducer);
  }
