...
import {ListItemHeader} from '@collab-ui/react';
...
function PeopleList({
        ...
        <div style={style} className={classNames('ciscospark-people-group', styles.group)} key={totalRows[index].details}>
          {
            ...
            && <ListItemHeader className={classNames('ciscospark-people-group-title', styles.title)} header={totalRows[index].details} isReadOnly />
          }
        </div>
      );
    }
  ...
  const list = canEdit && totalRows.length < 50 ? (
