...
export function fetchToUser({toPersonEmail, toPersonId}, spark) {
  return (dispatch) => {
    metrics.saveElapsedTime(`fetchToUser:start`);
    metrics.sendTempMetric(`fetchToUser:start`, spark);
    ...
    return spark.request(req).then((res) => {
      metrics.saveElapsedTime(`fetchToUser:end`);
      metrics.sendTempMetric(`fetchToUser:end`, spark);
      metrics.sendDurationMetric(`fetchToUser:duration`, `fetchToUser:start`, `fetchToUser:end`, spark);
