...
export function fetchToUser({toPersonEmail, toPersonId}, spark) {
  return (dispatch) => {
    metrics.saveElapsedTime(`startFetchingToUser`);
    metrics.sendTempMetric(`startFetchingToUser`, spark);
    ...
    return spark.request(req).then((res) => {
      metrics.saveElapsedTime(`finishFetchingToUser`);
      metrics.sendTempMetric(`finishFetchingToUser`, spark);
      metrics.sendDurationMetric(`fetchingToUserDuration`, `startFetchingToUser`, `finishFetchingToUser`, spark);
