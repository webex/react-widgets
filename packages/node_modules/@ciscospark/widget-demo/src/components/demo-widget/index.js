...
class DemoWidget extends Component {
  ...
  @autobind
  handleChangeStartCall(value) {
    return this.setState({startCall: value});
  }

  @autobind
  handleChangeSendMessage(value) {
    return this.setState({sendMessage: value});
  }
  ...
  openSpaceWidget({
    ...
    widgetOptions.startCall = this.state.startCall;
    widgetOptions.sendMessage = this.state.sendMessage;
              ...
              <div>
                ...
                { this.state.spaceRunning &&
                  <ExternalControl
                    ...
                    onChangeSendMessage={this.handleChangeSendMessage}
                    onChangeStartCall={this.handleChangeStartCall}
                  />
                }
              </div>
              <div>
