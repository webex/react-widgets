...
import {Button, Checkbox, Input, Topbar} from '@collab-ui/react';
...
class DemoWidget extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      recentsEnableUserProfile: cookies.get('recentsEnableUserProfile') === undefined ? true : cookies.get('recentsEnableUserProfile') === 'true',
  ...
  handleRecentSpaceLoadCountChange(e) {
    ...
    this.setState({spaceLoadCount: parsed});
  }
