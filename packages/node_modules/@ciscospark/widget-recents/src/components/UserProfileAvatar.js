...
import {Avatar, MenuContent, Menu, MenuItem, MenuOverlay} from '@collab-ui/react';
...
function ProfileAvatarMenu(props) {
  ...
  const menu = (
    ...
    >
      <MenuContent>
        <div className={classNames('ciscospark-recents-header-profile-menu', styles.menu)}>
          <Avatar
            src={currentUserWithAvatar.img}
            title={currentUserWithAvatar.displayName}
            size={84}
          />
          <div className={classNames('ciscospark-recents-header-profile-menu-info', styles.info)}>
      ...
      <Menu>
        <MenuItem
          className={classNames('ciscospark-recents-header-profile-menu-signout', styles.signout)}
