...
import {fetchSpaces, fetchSpacesEncrypted, fetchSpacesHydra} from '@ciscospark/redux-module-spaces';
...
function getInitialSpaces(props) {
  ...
  if (!widgetStatus.isFetchingInitialSpaces
    ...
    if (props.basicMode) {
      fetchCommand = props.fetchSpacesHydra(sparkInstance, {
       ...
       */
      fetchCommand = props.fetchSpacesEncrypted(sparkInstance, {
    ...
    fetchCommand.then(() => props.updateWidgetStatus({
...
export function setup(props) {
  ...
  if (sparkInstance
    ...
    if (!mercuryStatus.connected) {
      ...
      else if (!widgetStatus.hasFetchedAllSpaces && props.extendedLoad && !props.basicMode) {
        // Initial spaces have been fetched, load more
        getAllSpaces(props);
      }
      else if (!widgetStatus.hasFetchedAvatars && props.extendedLoad && !props.basicMode) {
