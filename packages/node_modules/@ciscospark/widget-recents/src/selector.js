...
const getRecentsWidgetProps = createSelector(
  [getWidget, getUsers, getSpaces, getRecentSpacesWithAvatarUrl, getSpark, getMedia, getTeams, getFeatures],
  (widget, user, spaces, spacesList, spark, media, teams, features) => {
