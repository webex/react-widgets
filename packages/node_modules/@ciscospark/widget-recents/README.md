...
This widget handles the heavy lifting of coordinating between your application and the Spark APIs, and provides components of the Spark recents lists experience without having to build all front end UI yourself.
