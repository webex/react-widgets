...
export function createConversationWithUser(userId, spark) {
  return (dispatch) => {
    metrics.saveElapsedTime(`startCreateConversation`);
    metrics.sendTempMetric(`startCreateConversation`, spark);
    ...
    return spark.conversation.create({
      ...
      .then((conversation) => {
        metrics.saveElapsedTime(`finishCreateConversation`);
        metrics.sendTempMetric(`finishCreateConversation`, spark);
        metrics.sendDurationMetric(`createConversationDuration`, `startCreateConversation`, `finishCreateConversation`, spark);
