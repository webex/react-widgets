...
export function createConversationWithUser(userId, spark) {
  return (dispatch) => {
    metrics.saveElapsedTime(`createConversation:start`);
    metrics.sendTempMetric(`createConversation:start`, spark);
    ...
    return spark.conversation.create({
      ...
      .then((conversation) => {
        metrics.saveElapsedTime(`createConversation:end`);
        metrics.sendTempMetric(`createConversation:end`, spark);
        metrics.sendDurationMetric(`createConversation:duration`, `createConversation:start`, `createConversation:end`, spark);
