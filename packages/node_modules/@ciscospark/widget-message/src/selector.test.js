...
import {records as UsersRecords} from '@ciscospark/redux-module-users';
...
describe('widget-message selectors', () => {
  ...
  describe('#getMessageWidgetProps selector', () => {
    it('should return message widget props', () => {
      ...
      const widget = fromJS({status: {hasFetchedAdaptiveCardFeature: false}});
      const props = getMessageWidgetProps.resultFunc(
        sparkInstance, sparkState, conversation, participants, activities, space, activitiesStatus, features, widget
      );
