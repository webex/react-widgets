...
import {handleConversationActivityEvent, handleExternalSendMessage} from './helpers';
...
const injectedPropTypes = {
  ...
  createAndSubmitActivity: PropTypes.func.isRequired,
...
export class MessageWidget extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // Check if props changed to send a message
    handleExternalSendMessage(nextProps, this.props);
  }
          ...
          <div className={classNames('ciscospark-widget-message-main-area', styles.mainArea)} onMouseMove={this.handleMouseMove}>
            <div className={classNames('ciscospark-activity-list-wrapper', styles.activityListWrapper)}>
              ...
              </ScrollingActivity>
              {
                ...
                <div className={classNames('ciscospark-scroll-to-bottom', styles.scrollToBottom)}>
                  <Button
