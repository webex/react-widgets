...
import {renderCardElement, CHOOSE_ONE, CHOOSE} from '@ciscospark/react-component-utils';
...
class MDChoiceSetInput extends AdaptiveCard.ChoiceSetInput {
  ...
  /**
 *  // renders momentum design Select and Radio Group component
 *  @returns {HTMLElement}
 */
  internalRender() {
    ...
    if (!this.isMultiSelect) {
      ...
      if (this.isCompact) {
        // Render Select box
        let defaultOptionText = CHOOSE_ONE;
    ...
    // Render Checkboxes
    const defaultOptionText = this.title || this.placeholder || CHOOSE;
