  ...
  switch (action.type) {
    ...
    case STORE_CALL: {
      ...
      if (id) {
        ...
        if (call.instance.locus && call.instance.locus.url) {
          updatedState = updatedState.setIn(['byLocusUrl', call.instance.locus.url], id);
        }
        return updatedState;
      }
      return state;
    ...
    case UPDATE_CALL_STATUS: {
      ...
      if (call.locus && call.locus.url &&
        state.getIn(['byLocusUrl', call.locus.url]) !== id) {
        ...
        // add new URL
        updatedState = updatedState.setIn(['byLocusUrl', call.locus.url], id);
      }
      return updatedState;
    }
    ...
    case ANSWERED_INCOMING_CALL:
      return state.setIn(['byId', action.payload.id, 'isAnswered'], true);
