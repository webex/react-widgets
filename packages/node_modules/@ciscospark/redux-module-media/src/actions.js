    ...
    spark.phone.createLocalMediaStream(constraints)
      .then((localMediaStream) => {
        const call = spark.phone.dial(
          userIdOrEmail,
          Object.assign({constraints, offerOptions: {offerToReceiveVideo: true, offerToReceiveAudio: true}}, {localMediaStream})
        );
  ...
  return (dispatch) => {
    ...
    spark.phone.createLocalMediaStream(constraints)
      .then((localMediaStream) => {
        ...
        incomingCall.answer(Object.assign({constraints, offerOptions: {offerToReceiveVideo: true, offerToReceiveAudio: true}}, {localMediaStream}))
          .then(() => {
            dispatch(removeCallIncoming(incomingCall));
          });
      });
