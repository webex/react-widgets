...
export function updateCallState(call, id) {
  return {
...
export function storeCall(call, id) {
  return {
    type: STORE_CALL,
    payload: {
      call,
...
function bindEvents(dispatch, call) {
  ...
  call.on(`remoteMediaStream:change`, () => dispatch(updateCallState(call)));
  call.on(`localMediaStream:change`, () => dispatch(updateCallState(call)));
}
