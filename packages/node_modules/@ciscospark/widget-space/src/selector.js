...
export const getSpaceWidgetProps = createSelector(
  ...
  (widget, spark, media, spaceDetails, activityTypes) => ({ // eslint-disable-line max-params
    activityTypes,
    media,
