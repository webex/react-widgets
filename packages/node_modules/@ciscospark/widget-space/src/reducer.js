...
export function reducer(state = initialState, action) {
  ...
  case TOGGLE_ACTIVITY_MENU_VISIBLE:
    return state.setIn([`status`, `activityMenuVisible`], !state.get(`activityMenuVisible`));
