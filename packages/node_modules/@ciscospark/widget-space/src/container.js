...
export class SpaceWidget extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (!props.spaceDetails && spaceDetails) {
      if (activityTypes.find((a) => a.get(`name`) === initialActivity)) {
  ...
  constructSecondaryActivityWidget(activityTypes, secondaryActivityType) {
    ...
    return activityTypes.toJS()
      ...
      // TODO: Actually render the widget
      .map((activityType) => {
        ...
        return (
          ...
          >
            {activityType.name}
            <button onClick={this.handleSecondaryDismiss}>XXX</button>
            <button onClick={this.handleMenuClick}>OOO</button>
            <Widget
              {...this.props}
              eventNames={eventNames}
              injectProvider={false}
