# Webex Teams Space Widget _(@ciscospark/widget-space)_
...
### NPM
1. Simply install the module via NPM

  ```bash
  npm install @ciscospark/widget-space
  ```
...
2. Add the following import statements
  ...
  import '@ciscospark/widget-space/es/main.css';
  ```
  a. `destinationTypes` are the followings:
    - USERID
    - EMAIL
    - SPACEID
    - SID
