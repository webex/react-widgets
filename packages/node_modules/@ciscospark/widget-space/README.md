...
If you need additional behaviors or need to do additional work before the widget loads, it may be useful to programmatically instatiate the widget after the intial page loads.
