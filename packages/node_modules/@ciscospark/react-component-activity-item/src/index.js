...
export default function ActivityItem(props) {
  ...
  if (typeof formatter === `function`) {
    formattedActivity = formatter(activity);
  }

  if (verb === POST_VERB) {
    itemComponent = ( // eslint-disable-line no-extra-parens
      <ActivityPost
        content={formattedActivity.content}
        displayName={formattedActivity.displayName}
        {...props}
      />
    );
  }
    ...
    itemComponent = ( // eslint-disable-line no-extra-parens
      <ActivityShareFiles
        content={formattedActivity.content}
        displayName={formattedActivity.displayName}
        files={formattedActivity.files.items}
        {...props}
      />
    );
  }
