...
1.  Follow these instructions to checkout and build the SDK <https://github.com/ciscospark/react-ciscospark/blob/master/README.md>
1.  Be sure to run `npm install` from the root of the sdk repo. You will want to run this every time you pull down any new updates for the sdk.
...
1.  Create a container where you would like to embed the widget and add the following attributes to configure the widget:
  ...
  - `data-activity`: (default: `message`) Activity view to open with the widget. Available options:
