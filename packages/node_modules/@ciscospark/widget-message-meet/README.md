...
```html
<div id="ciscospark-widget" />
<script>
  var widgetEl = document.getElementById('ciscospark-widget');
    // Init a new widget
  ciscospark.widget(chatEl).messageMeet({
...
``` js
var widget = document.getElementById('ciscospark-widget');
ciscospark.widget(chatEl).on('messages:created', function(e) {
