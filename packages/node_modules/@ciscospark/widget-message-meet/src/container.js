...
export class MessageMeetWidget extends Component {
  ...
  componentWillMount() {
    if (this.props.initialActivity === INITIAL_ACTIVITY_TYPE_MEET) {
      this.props.setActivityMeet();
    }
    if (this.props.initialActivity === INITIAL_ACTIVITY_TYPE_MENU) {
      this.props.showActivityMenu();
    }
  }
  ...
  render() {
    ...
    const shouldShowActivityMenu = widgetMessageMeet.get(`showActivityMenu`);
...
const injectedPropTypes = {
  ...
  showActivityMenu: PropTypes.func,
