...
export function reducer(state = initialState, action) {
  switch (action.type) {
  case SHOW_ACTIVITY_MENU:
    return state.set(`showActivityMenu`, true);
