...
function Avatar({
  ...
  if (isSelfAvatar) {
    avatarContents = <span className={classNames('ciscospark-avatar-self', styles.avatarSelf)}><Icon color="#04c9ef" type={ICONS.ICON_TYPE_MESSAGE} /></span>;
  }
  else if (image) {
  ...
  return (
    <div className={classNames('ciscospark-avatar', styles.avatar, avatarClass)} style={backgroundStyle}>
      {avatarContents}
    </div>
  );
}
