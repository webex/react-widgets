  ...
  return (BaseComponent) => {
    ...
    class InjectSparkMetrics extends Component {
      ...
      render() {
        ...
        return <BaseComponent metrics={metrics} {...this.props} />;
      }
    }

    InjectSparkMetrics.propTypes = injectedProps;

    InjectSparkMetrics.WrappedComponent = BaseComponent;

    return compose(
      setDisplayName(wrapDisplayName(BaseComponent, 'withSparkMetrics')),
      connect(
        (state) => ({
