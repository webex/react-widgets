  ...
  return (
    ...
    >
      ...
      <View className="space-avatar-wrapper" style={rnStyles.avatarWrapper}>
        <View className="space-avatar-border" style={type === 'group' ? rnStyles.avatarGroup : rnStyles.avatarBorder}>
          <Avatar baseColor={teamColor} image={avatarUrl} name={name} size={38} />
        </View>
      </View>
