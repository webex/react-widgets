...
class DemoWidgetSpace extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      displayToken: false,
      initialActivity: cookies.get('initialActivity') || 'message',
      mode,
      running: false,
      toPersonEmail,
      spaceId
...
<script>
  ...
  render() {
    const displayActivityWarning = !this.state.activities[this.state.initialActivity];
            ...
            <CardText expandable>
              ...
              <div className={classNames(styles.select)}>
                <RadioButtonGroup
                  ...
                  onChange={this.handleInitialActivityChange}
                  valueSelected={this.state.initialActivity}
                >
                  <RadioButton
                    aria-label="Message"
                    label="Message"
