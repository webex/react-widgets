...
export const attachmentType = 'AdaptiveCard';
export const cardReference = 'cardReference';
export const cards = 'cards';

export const DEVELOPER = 'developer';
export const WIDGET_ADAPTIVE_CARD = 'WIDGET_ADAPTIVE_CARD';
export const WIDGET_ADAPTIVE_CARD_OFF = 'WIDGET_ADAPTIVE_CARD_OFF';
export const WIDGET_ADAPTIVE_CARD_ON = 'WIDGET_ADAPTIVE_CARD_ON';
