...
AdaptiveCard.AdaptiveCard.onProcessMarkdown = function processMarkdown(text, result = {}) {
  ...
  try {
    ...
    computedResult.outputHtml = markedString !== null ? markedString : text;
    computedResult.didProcess = true;
  }
  catch (err) {
    computedResult.didProcess = false;
  }
  Object.assign(result, computedResult);
