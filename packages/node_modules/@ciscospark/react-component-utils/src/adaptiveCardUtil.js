...
import {createMessageObject} from '@ciscospark/redux-module-activity';

import {CARD_ATTACHMENT_TYPE, TEXT_INPUT_ELEMENT, TOGGLE_INPUT_ELEMENT, CHOICE_SET_INPUT_ELEMENT, ADAPTIVE_CARD_HOST_CONFIG, ADAPTIVE_CARD_OPEN_URL_ACTION, ADAPTIVE_CARD_SUBMIT_ACTION} from './constants';
...
export function getAdaptiveCard(
  cards, displayName, sdkInstance, addChildNode = null, parentActivity, convo, handleSubmitAction
) {
