...
import {CARD_ATTACHMENT_TYPE, TEXT_INPUT, TOGGLE_INPUT, CHOICE_SET_INPUT} from './constants';
...
function getPatchedAdaptiveCard(addChildNode = null) {
  AdaptiveCard.AdaptiveCard.elementTypeRegistry.registerType(TEXT_INPUT, () => new MDTextInput(addChildNode));
  AdaptiveCard.AdaptiveCard.elementTypeRegistry.registerType(TOGGLE_INPUT, () => new MDToggleInput(addChildNode));
