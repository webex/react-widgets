...
function constructSpace(space, teams) {
  const s = {
    ...
    lasteSeenActivityDate: space.lastSeenActivityDate,
...
export function updateSpaceWithActivity(activity) {
...
export function acknowledgeSpace(activity) {
  ...
  return {
    ...
    payload: {
      space: {
        id: activity.target.id,
        lasteSeenActivityDate: activity.published
      }
    }
  };
}
