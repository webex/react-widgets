  ...
  const buttons = [
    {
      ...
      buttonClassName: classNames(styles.audioButton, sendingAudio === false ? styles.audioStartSending : styles.audioStopSending),
    ...
    },
    {
      ...
      buttonClassName: classNames(styles.videoButton, sendingVideo === false ? styles.videoStartSending : styles.videoStopSending),
