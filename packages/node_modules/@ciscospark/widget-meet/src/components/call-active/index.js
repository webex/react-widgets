...
export default function ActiveCall({
  ...
  const buttons = [
    {
      ...
      buttonClassName: classNames(styles.audioButton, sendingAudio ? styles.audioStopSending : styles.audioStartSending),
      onClick: sendingAudio ? onStopSendingAudio : onStartSendingAudio
    },
    {
      iconType: ICON_TYPE_VIDEO_CROSS_OUTLINE,
      buttonClassName: classNames(styles.videoButton, sendingVideo ? styles.videoStopSending : styles.videoStartSending),
  ...
  let remoteView = ( // eslint-disable-line no-extra-parens
    <div className={classNames(styles.avatarView, `remote-avatar-view`)}>
      <Avatar image={toPersonAvatar} name={toPersonName} />
    </div>
  );
