...
export class MeetWidget extends Component {
  ...
  catchCallError(e) {
    ...
    const displayTitle = formatMessage(messages.unableToCallMessage);
    const actionTitle = formatMessage(messages.okButtonLabel);
    let displaySubtitle;
    switch (e.name) {
    case `DevicesNotFoundError`:
      displaySubtitle = formatMessage(messages.callErrorDeviceNotFound);
      break;
    case `NotAllowedError`:
      displaySubtitle = formatMessage(messages.callErrorNotAllowed);
      break;
    default:
      displaySubtitle = formatMessage(messages.callErrorUnknownMessage);
    }
    props.addError({
      actionTitle,
      code: e.name,
