...
import {formatDate, getAdaptiveCardFeatureState} from '@ciscospark/react-component-utils';
...
function ActivityList(props) {
  ...
  return (
    <div className={classNames('ciscospark-activity-list', styles.activityList)}>
      {items}
    </div>
  );
}
