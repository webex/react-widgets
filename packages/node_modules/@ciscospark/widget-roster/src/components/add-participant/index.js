    ...
    if (searchResults.inProgress) {
      ...
      results = (
        <div
          ...
          tabIndex="0"
        >
          <div className={classNames(`${baseClassPrefix}-results-invite-icon`, styles.resultsInviteIcon)}><Icon type={ICONS.ICON_TYPE_INVITE} /></div>
      ...
      <div className={classNames(styles.searchBar)}>
        ...
        <div className={classNames(`${baseClassPrefix}-close-button-container`, styles.closeButton)}>
          <Button
            ...
            buttonClassName={classNames(`${baseClassPrefix}-close-button`)}
            iconColor="#aaa"
