...
export class RosterWidget extends Component {
  ...
  render() {
    ...
    if (!this.props.conversation.has(`participants`)) {
      ...
      const {hasExternalParticipants, participantsCurrentUser, participantsModerators, participantsOther} = this.props;
      ...
      if (participantsModerators && participantsModerators.length) {
        ...
        moderators = (
          <div>
            <div className={classNames(`ciscospark-roster-participants-separator`, styles.participantsSeparator)}>{`Moderators`}</div>
