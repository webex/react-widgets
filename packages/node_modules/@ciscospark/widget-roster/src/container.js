  ...
  render() {
    ...
    if (!this.props.conversation.has(`participants`)) {
      ...
      if (currentView === VIEW_ADD) {
          ...
          moderators = (
            <div>
              <div className={classNames(`ciscospark-roster-participants-separator`, styles.participantsSeparator)}>
                {this.formattedMessages.moderators}
              </div>
              <div><ParticipantList onEdit={this.handleRosterEdit} participants={participantsModerators} /></div>
            </div>
          );
        }
        // eslint-disable-next-line no-extra-parens
        content = (
          <div>
            {addPeopleButton}
            <div>
              <ParticipantList onEdit={this.handleRosterEdit} participants={participantsCurrentUser} />
            </div>
            {moderators}
            <div className={classNames(`ciscospark-roster-participants-separator`, styles.participantsSeparator)}>
              {this.formattedMessages.participants}
            </div>
            <div>
              <ParticipantList
                onEdit={this.handleRosterEdit}
                participants={participantsOther}
              />
            </div>
          </div>
        );
      ...
      mainArea = (
        <div>
          {
            hasExternalParticipants && <ExternalParticipantMessage message={this.formattedMessages.externalParticipants} />
          }
          {content}
        </div>
      );
