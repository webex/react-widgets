...
export const SET_PARTICIPANT_EDITING = 'widget-roster/SET_PARTICIPANT_EDITING';
export const UPDATE_WIDGET_STATE = 'widget-roster/UPDATE_WIDGET_STATE';

/**
 * Sets if a participant is being edited
 *
 * @export
 * @param {object|boolean} participant
 * @returns {Object}
 */
export function setParticipantEditing(participant) {
  return {
