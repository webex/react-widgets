...
/**
 * Formats and filters activity content
 *
 * @param {Object} activityObject raw activity.object
 * @returns {Object}
 */

export function formatActivity(activityObject) {
  let outputActivity;
  const linkifyOptions = {
    ignoreTags: [`code`, `pre`],
    className: `ciscospark-activity-link`
  };
  if (activityObject.content) {
    ...
    outputActivity = Object.assign({}, activityObject, {content: linkifyHtml(cleaned, linkifyOptions)});
  }
  else {
    outputActivity = Object.assign({}, activityObject, {content: linkifyStr(activityObject.displayName, linkifyOptions)});
  }
