      ...
      if (isActivityVisible(activity)) {
        ...
        if (activity.verb === `post`) {
          formattedActivity = Object.assign({}, activity, {
            object: formatActivity(activity.object, activityFormatter)
          });
        }
...
export function formatActivity(activity, activityFormatter) {
  const activityObject = filterActivity(activity);

  if (typeof activityFormatter === `function`) {
    return activityFormatter(activityObject, defaultFormatters);
  }
