...
describe('redux-module-activity actions', () => {
  ...
  it('has exported actions', () => {
    ...
    expect(actions.createAndSubmitActivity).toBeDefined();
  ...
  describe('#createAndSubmitActivity', () => {
    it('does not submit an empty activity', () => {
      const store = mockStore({});
      return store.dispatch(actions.createAndSubmitActivity({
        conversation: toImmutable(conversation),
        message: '',
        user: {},
        spark: mockSpark
      }))
