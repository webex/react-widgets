...
export class MessageComposer extends Component {
  ...
  handleTextChange(e) {
    ...
    if (e.target.value === ``) {
      ...
      props.setUserTyping(false, conversation.toJS(), spark);
    }
  }
  ...
  handleSubmit() {
    ...
    props.setUserTyping(false, conversation.toJS(), spark);
    props.submitActivity(conversation.toJS(), activity, user.get(`currentUser`), spark);
    if (onSubmit) {
      onSubmit();
    }
  }
  ...
  sendTyping(props) {
    ...
    props.setUserTyping(true, conversation.toJS(), spark);
  }
