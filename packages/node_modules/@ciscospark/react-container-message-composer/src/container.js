...
export class MessageComposer extends Component {
  ...
  render() {
    ...
    const textareaClassnames = [`ciscospark-textarea-container`];
    if (this.textShouldGrow(text)) {
      textareaClassnames.push(styles.textareaContainerBig);
    }
    ...
    return (
      <div className={classNames(`ciscospark-message-composer`, styles.messageComposer, textAreaFocusStyle)}>
        ...
        <div className={classNames(textareaClassnames)}>
          {
            showMentions &&
            <MentionsInput
