...
import {initialState as messageInitialState} from '@ciscospark/redux-module-messaging';
...
describe('MessageComposer component', () => {
  ...
  describe('class method tests', () => {
    ...
    it('sends message properly', () => {
      const props = {
        activity: messageInitialState.set('text', 'testing'),
        conversation: new Map(),
        setUserTyping: jest.fn(),
        submitActivity: jest.fn(),
        user: new Map({
